...
public class Sale_GUI extends javax.swing.JPanel implements checkPermission{
    ...
    public void addBill( ArrayList<Product_DTO> list_Detail_Bill, ArrayList<Integer> list_Quantity_Choice){
        ...
        int usedpoint = 0;
        if(!txtTichLuy.getText().isBlank())
            usedpoint = Integer.parseInt(txtTichLuy.getText());
        double tt=totalPrice-usedpoint*1000;
        if(tt<0) lblTongTien.setText("0");
        else
        lblTongTien.setText(format.format(tt));
    }
    ...
    private void initComponents() {
        ...
        lblTichLuy = new javax.swing.JLabel();
        ...
        btnAdd1.setColorClick(new java.awt.Color(240, 240, 240));
        ...
        btnAdd.setColorClick(new java.awt.Color(240, 240, 240));
        ...
        lblTichLuy.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblTichLuy.setText("0");

        txtTichLuy.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtTichLuy.setText("0");
        txtTichLuy.setMargin(new java.awt.Insets(2, 6, 2, 0));
                        ...
                        .addGroup(roundPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(roundPanel6Layout.createSequentialGroup()
                                ...
                                .addGroup(roundPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(roundPanel6Layout.createSequentialGroup()
                                        .addGap(11, 11, 11)
                                        .addComponent(txtTichLuy, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(roundPanel6Layout.createSequentialGroup()
                                        .addGap(34, 34, 34)
                                        .addComponent(lblTichLuy, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))))
                            .addGroup(roundPanel6Layout.createSequentialGroup()
        ...
        roundPanel6Layout.setVerticalGroup(
            ...
            .addGroup(roundPanel6Layout.createSequentialGroup()
                ...
                .addGroup(roundPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel11)
                    .addComponent(lblTichLuy))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(roundPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel12)
                    .addComponent(txtTichLuy, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(roundPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel13)
        ...
        jTextField3.getDocument().addDocumentListener(new DocumentListener() {
            ...
            protected void updateFieldState() {
                ...
                if(jTextField3.getText().isBlank()|| !(jTextField3.getText().matches("-?\\d+"))) {
                    ...
                    try {
                        totalCash = NumberFormat.getCurrencyInstance(locale).parse(lblTongTien.getText()).doubleValue();
                    }
                    catch (ParseException ex) {
                        Logger.getLogger(Sale_GUI.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    double excessCash = -1*(totalCash - receiveCash);
                    jLabel9.setText(format.format(excessCash)+"");
                }
            }
        });
        txtTichLuy.getDocument().addDocumentListener(new DocumentListener() {
            ...
            protected void updateFieldState() {
                ...
                NumberFormat format = NumberFormat.getCurrencyInstance(locale);
                //format.setRoundingMode(RoundingMode.HALF_UP);
                if(txtTichLuy.getText().isBlank()|| !(txtTichLuy.getText().matches("-?\\d+"))) {
                    lblTongTien.setText(jLabel7.getText());
                }
                else {
                    try {
                        double excessMoney = 0;
                        double tongTien = NumberFormat.getCurrencyInstance(locale).parse(jLabel7.getText()).doubleValue()-Integer.parseInt(txtTichLuy.getText())*1000;
                        if(!jTextField3.getText().isBlank())
                        excessMoney = -1*(tongTien - Double.parseDouble(jTextField3.getText()));
                        lblTongTien.setText(format.format(tongTien));
                        jLabel9.setText(format.format(excessMoney));
    ...
    private void button2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_button2MouseClicked
        DecentralizationDetail decent_detail = dcdtBUS.readById(this.dcdt);
        if(decent_detail!=null)
        ...
        if(phoneNum.isBlank() || phoneNum.equals("Số điện thoại")) {
            ...
            if(customer == null) {
                ...
                lblTichLuy.setText(customer.getPurchaseTimes()+"");
    ...
    private void btnAdd1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAdd1MouseClicked
        ...
        if(list_Detail_Bill.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Đơn hàng đang trống!", "Warning", JOptionPane.WARNING_MESSAGE);
        }
        else if(totalCash<0 || Integer.parseInt(lblTichLuy.getText())<Integer.parseInt(txtTichLuy.getText())) {
        JOptionPane.showMessageDialog(this, "Sử dụng quá số điểm!", "Warning", JOptionPane.WARNING_MESSAGE);
        }
            ...
            if(txtTichLuy.getText().isBlank()|| !(txtTichLuy.getText().matches("-?\\d+")))
                b.setPurchasePoint(0);
            else
                b.setPurchasePoint(Integer.parseInt(txtTichLuy.getText()));
            ...
            if(bill_BUS.Insert(b)) {                
                if(!b.getCustomerID().equals("C0")){
                    int pointUsed=b.getPurchasePoint();
                    customer_BUS.updatePurchaseTime(this.customer.getCustomerId(), this.customer.getPurchaseTimes()+1-pointUsed);
                }
                for(int i=0; i<list_Detail_Bill.size(); i++) {
    ...
    private javax.swing.JLabel lblTichLuy;
