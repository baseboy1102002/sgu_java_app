...
public class Statistic_GUI extends javax.swing.JPanel {
   ...
   public void pieChart(String month) {
       ...
       if(cL.isEmpty()) WarningC.setVisible(true);
       else{ 
           WarningC.setVisible(false);
           GUI.PieChart customerChart = new GUI.PieChart(cL,"customer");
       ...
       if(spL.isEmpty()) WarningS.setVisible(true);
       else{
           WarningS.setVisible(false);
           GUI.PieChart soldProductChart = new GUI.PieChart(spL,"");
       ...
       if(rpL.isEmpty()) WarningR.setVisible(true);
       else {
           WarningR.setVisible(false);
           GUI.PieChart receivedProductChart = new GUI.PieChart(rpL,"");
        ...
        roundPanel14.revalidate();
        roundPanel14.repaint();
   }
    ...
    private void jTabbedPane1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jTabbedPane1StateChanged
        if(jPanel10.isVisible() || jPanel11.isVisible())
    ...
    private void button11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button11ActionPerformed
        try{
            ...
            JOptionPane.showMessageDialog(this, "Vui lòng nhập chuẩn định dạng", "Warning", JOptionPane.WARNING_MESSAGE);
                ...
                Component[] componentList= roundPanel14.getComponents();
                for(Component c : componentList)
                    if(c instanceof GUI.PieChart)
                        roundPanel14.remove(c);
