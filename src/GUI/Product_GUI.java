...
public class Product_GUI extends javax.swing.JPanel implements checkPermission{
    ...
    private void initComponents() {
        ...
        txtQuantityAddSize.setEditable(false);
        txtQuantityAddSize.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        txtQuantityAddSize.setText("0");
    ...
    private void btnAddSizeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddSizeActionPerformed
        ...
        if (!txtProductID1.getText().isEmpty()) {
            ...
            if (option == JOptionPane.OK_OPTION) {
                try {
                    if (txtPriceAddSize.getText().isEmpty() || txtSizeAddSize.getText().isEmpty()) {
                        ...
                        if (productBUS.productDeletedPreviously(id, txtSizeAddSize.getText())) {
                            if (productBUS.restoreProduct(id, txtSizeAddSize.getText(), Integer.parseInt(txtPriceAddSize.getText()), 0)) {
                                JOptionPane.showMessageDialog(pnlAddSize, "Thêm size sản phẩm thành công");
                                listProduct = productBUS.loadDataProduct();
                                loadProductList(listProduct);
                            }
                        } else {
                            Product_DTO product = new Product_DTO(selectedProduct.getProductID(), txtSizeAddSize.getText(), selectedProduct.getProductName(), selectedProduct.getCategoryID(), Integer.parseInt(txtPriceAddSize.getText()), 0, selectedProduct.getImage(), false, selectedProduct.isBusinessStatus());
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try {
            ...
            if (isInputEmpty()) {
                ...
                Product_DTO product = new Product_DTO(newID, txtSizeID1.getText(), txtProductName1.getText(), cbbCategoryID1.getSelectedItem() + "", Integer.parseInt(txtPrice1.getText()), 0, chosenImg, false, true);
                if (productBUS.insertProduct(product)) {
