...
public class Bill {
    ...
    public Bill(String bill_ID, LocalDateTime date, double totalValue, double receivedMoney, double excessMoney,int purchasePoint, String staffID, String CustomerID) {
